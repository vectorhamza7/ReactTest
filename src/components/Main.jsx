...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-amber-50 text-black">
      <div className="text-center px-4">
        <h1 id="heroText" ref={text} className=" text-5xl md:text-black lg:text-amber-400 font-bold mb-6 bg-gradient-to-r from-amber-400 to-orange-500 bg-clip-text text-transparent">
          Welcome to Our Site
        </h1>
